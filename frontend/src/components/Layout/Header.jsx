  ...
  return (
    <>
                ...
                {searchData.map((i, index) => (
                  <Link to={`/product/${i._id}`} key={i._id}>
                    <div className="w-full flex items-start py-3">
                      {i.images && i.images[0] ? (
                        <img
                          src={`${backend_url}${i.images[0]}`} // Loại bỏ /uploads/ nếu có
                          className="w-[50px] h-[50px] rounded-full border-[3px] border-[#4cf1d6]"
                          alt="User Avatar"
                        />
                      ) : null}
                      <h1>{i.name}</h1>
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-[#9be2f6] h-[70px]`}
      >
        <div
            ...
            <div className={styles.noramlFlex}>
              <div className="relative cursor-pointer mr-[15px]">
                {isAuthenticated ? (
                  <Link to="/profile">
                    <img
                      src={fileUrl} // Loại bỏ /uploads/ nếu có
                      className="w-[50px] h-[50px] rounded-full border-[3px] border-[#4cf1d6]"
                      alt="User Avatar"
                    />
                  </Link>
